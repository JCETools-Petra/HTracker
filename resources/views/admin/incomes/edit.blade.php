                    ...
                    <form method="POST" action="{{ route('admin.incomes.update', $income->id) }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                            ...
                            <div class="col-span-1 md:col-start-2">
                                ...
                                <x-text-input id="beverage_income" class="block mt-1 w-full" type="number" name="beverage_income" :value="old('beverage_income', $income->beverage_income)" />
                            </div>
                            ...
                            <div class="col-span-1 md:col-start-2">
                                ...
                                <x-text-input id="package_income" class="block mt-1 w-full" type="number" name="package_income" :value="old('package_income', $income->package_income)" />
                            </div>

                            <div class="col-span-1 md:col-start-2">
                                <x-input-label for="rental_area_income" :value="__('Rental Area (Pendapatan)')" />
                                <x-text-input id="rental_area_income" class="block mt-1 w-full" type="number" name="rental_area_income" :value="old('rental_area_income', $income->rental_area_income)" />
                            </div>
