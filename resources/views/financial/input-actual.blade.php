    ...
    <x-slot name="header">
        <div class="flex flex-wrap justify-between items-center">
            ...
            <nav class="flex flex-wrap items-center space-x-2 sm:space-x-3">
                <x-nav-link :href="route('financial.report')" class="ml-3">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <!-- Period Selection -->
                    <form method="GET" action="{{ route('financial.input-actual') }}" class="mb-6 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg shadow">
                    ...
                    <!-- Input Form -->
                    <form method="POST" action="{{ route('financial.input-actual.store') }}" x-data="{ activeTab: 0 }">
                        @csrf
                        ...
                        <div class="mt-6 flex justify-end space-x-3">
                            <a href="{{ route('financial.report') }}" class="px-6 py-2 bg-gray-600 text-white rounded-md hover:bg-gray-700">
                                Batal
                            </a>
